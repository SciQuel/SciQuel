      ...
      <DictionaryProvider dictionary={testDictionary}>
        <div className="flex w-screen flex-col overflow-x-hidden">
          ...
          <div className="mx-2 mt-2 flex flex-col items-center gap-5 md:mx-auto">
            ...
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              <DictionarySentence>
                <DictionaryWord word="camouflage">Camouflage</DictionaryWord> is
                a technique especially useful if the animal can change colour to
              ...
              fallen leaves on a stream bed (Sazima et al. 2006), to even making
              the body effectively transparent, as occurs in a range of, in
              particular, aquatic species (Johnsen 2001; Carvalho et al. 2006).
              Examples such as leaf mimicry in butterflies helped convince
              Wallace (1889), for example, of the power of natural selection.
              Other strategies may even stretch to the use of bioluminescence to
              hide shadows generated in aquatic environments (Johnsen et al.
              2004), and include ‘decorating’ the body with items from the
              general environment, such as do some crabs (Hultgren & Stachowicz
              2008).
            </p>
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              <DictionarySentence>
              ...
              biological reactions are catalyzed by proteins. In the absence of
              enzymatic catalysis, most biochemical reactions are so slow that
              they would not occur under the mild conditions of temperature and
            ...
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              ...
              Much of the initial attention LPS received in the early 1900s was
              owed to its ability to stimulate the immune system, for which the
            ...
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              ...
              an essential component of the cell envelope in most, though
              interestingly not all, Gram-negative bacteria (4). In addition,
              LPS molecules transform the OM into an effective permeability
              barrier against small, hydrophobic molecules that can otherwise
              cross phospholipid bilayers, making Gram-negative bacteria
              innately resistant to many antimicrobial compounds (5, 6). LPS can
              also play a crucial role in bacteria-host interactions by
              modulating responses by the host immune system.
            </p>
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              <DictionarySentence>
                Like all other catalysts,{" "}
                <DictionaryWord word="enzyme">enzymes</DictionaryWord> are
            ...
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              ...
              protective markings, rather than working from the perspective of
            ...
            <p className="mx-0 w-full font-sourceSerif4 text-lg font-[370] leading-8 md:w-[720px]">
              ...
              <DictionarySentence>
                {" "}
                <DictionaryWord word="enzyme" /> Has capiti fatis.
              </DictionarySentence>
              Exemit puer sors esse, Pittheia nobis superfusis mihi Carpathius
              quoque libera oris, nec.
              <DictionarySentence>
                {" "}
                Quae retinere <DictionaryWord word="lipopolysaccharide" /> ictus
                nam vultum sanguine precibus Delphosque mucrone.
              </DictionarySentence>{" "}
              <DictionarySentence>
                {" "}
