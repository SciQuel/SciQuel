...
export default async function ReadingHistory() {
  ...
  //if data is in bookmarkedReadings, add reading atribute to true, use nested for loop for now until i find better way

  // This works but should this be handled on backend somehow. wondering about performance???
  // for (const reading of data) {
  //   for (const bookmarked of bookmarkedReadings) {

  //     if (reading.storyId === bookmarked.storyId) {
  //       console.log(reading)
  //       reading['bookmarked'] = true
  //       break


  //     } else {
  //       reading['bookmarked'] = false
  //     }
  //   }
  ...
  return (
    ...
    <div className="flex flex-col flex-grow mr-36">
      ...
      <h2 className='ml-8 mt-8 text-2xl mb-10' > Reading History </h2>
