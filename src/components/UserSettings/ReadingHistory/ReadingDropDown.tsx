...
const ReadingDropDown: React.FC<PropTypes> = ({ data, title, email, brained, bookmarked, openDropDown, onClick }) => {
  ...
  return (
    <>
      <DropDownTabs openDropDown={openDropDown} title={title} onClick={onClick} />

      {openDropDown === title && (
        <DropDownContent data={data} bookMarkedReadingsIds={bookMarkedReadingsIds} brainedReadingIds={brainedReadingIds} handleBookmarkClick={handleBookmarkClick} handleBrainClick={handleBrainClick} />
