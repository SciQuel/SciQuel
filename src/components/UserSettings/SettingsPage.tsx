...
export default function Settings() {
  ...
  return (
    <div className={`${darkMode && "dark"}`} style={{ fontSize: `${fontSize}px` }}>
      <div className="relative flex grow flex-col gap-8 py-6 md:pl-56 ">
        <section>
          ...
          <ul className="divide-y rounded-md border bg-white dark:bg-sciquelMuted px-4 text-xl font-semibold dark:text-white">
            <li className="flex h-16 items-center justify-between" style={{ fontSize: `${fontSize}px` }}>
              Reading History
        ...
        <section>
          <div className="flex items-center gap-1 dark:text-white" style={{ fontSize: `${fontSize}px` }}>
            <h3 className="text-xl font-semibold">INTERESTS</h3>
            <InterestIcon className="h-7 w-7" />
          </div>
          <p className="mb-4 text-lg text-stone-500  dark:sciquelMuted">
            Pick the curated content you want to see most.
          </p>
          <div className="grid max-h-96 auto-rows-max grid-cols-1 gap-2 overflow-auto rounded-md border bg-white dark:bg-sciquelMuted dark:text-white p-4 md:grid-cols-2">
        ...
        <section className="" style={{ fontSize: `${fontSize}px` }}>
          <div className="flex items-center gap-1  dark:text-white">
            <h3 className="text-xl font-semibold" style={{ fontSize: `${fontSize}px` }}>SECURITY</h3>
          </div>
          <p className="mb-4 text-lg text-stone-500  dark:sciquelMuted">
        ...
        <section className="">
          ...
          <ul className="divide-y rounded-md border bg-white px-4 text-xl font-semibold dark:bg-sciquelMuted dark:text-white">
            <li className="flex h-16 items-center justify-between" style={{ fontSize: `${fontSize}px` }}>
              Dark mode <ToggleSwitch id="dark-mode" isChecked={darkMode} onToggle={toggleDarkMode} />
            </li>
            <li className="flex h-32 flex-col justify-between py-4" style={{ fontSize: `${fontSize}px` }}>
              <p className="">Text size</p>
              <FontSlider fontSize={fontSize} setFontSize={setFontSize} />
            </li>
            <li className="min-h-16 flex items-center justify-between" style={{ fontSize: `${fontSize}px` }}>
