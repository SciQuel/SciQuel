    ...
    <div className="quiz-btn-container mb-1 mt-5 flex justify-between">
      {showPreviousButton && (
        <button
          ...
          className="font-quicksand border-radius-4 mr-auto flex h-10
             cursor-pointer flex-row items-center justify-center gap-4 rounded-sm border border-black bg-white px-4 py-1 text-lg font-medium text-black transition duration-300 hover:bg-gray-200 md:text-base"
        >
      ...
      {showSubmitButton && (
        <button
          ...
          className="font-quicksand border-radius-4 ml-auto h-10 cursor-pointer rounded-sm border border-black bg-white px-4 py-1 text-lg font-medium text-black transition duration-300 hover:bg-gray-200 md:text-base"
        >
          Submit
        </button>
      )}
